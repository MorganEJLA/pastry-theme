...
<li class="pastry-card">
  ...
  <?php
    // Moved OUTSIDE the <a> above -- nesting a link inside another
    // link is invalid HTML and breaks click behavior. These tags
    // need their own click target, separate from the card link.
